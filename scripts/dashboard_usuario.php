...
// Obtener el usuario seleccionado desde el parámetro GET o inicializar como null
$usuarioID = isset($_GET['usuario_id']) ? $_GET['usuario_id'] : null;

// Inicializar datos del usuario y presupuesto
$usuario = null;
$presupuesto = isset($_GET['presupuesto']) ? floatval($_GET['presupuesto']) : 100;

// Si hay un usuario seleccionado, obtener sus datos
if ($usuarioID) {
